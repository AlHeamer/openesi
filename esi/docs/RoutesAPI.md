...
func main() {
	originSystemId := TODO // int64 | Origin system
	destinationSystemId := TODO // int64 | Destination system
...
**originSystemId** | [**int64**](.md) | Origin system | 
**destinationSystemId** | [**int64**](.md) | Destination system | 
