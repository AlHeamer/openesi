...
// TypeId1AsCorporationsProjectsDetailConfigurationdeliveritemItemsInner is a convenience function that returns TypeId1 wrapped in CorporationsProjectsDetailConfigurationdeliveritemItemsInner
func TypeId1AsCorporationsProjectsDetailConfigurationdeliveritemItemsInner(v *TypeId1) CorporationsProjectsDetailConfigurationdeliveritemItemsInner {
	return CorporationsProjectsDetailConfigurationdeliveritemItemsInner{
		TypeId1: v,
	}
}
...
func (dst *CorporationsProjectsDetailConfigurationdeliveritemItemsInner) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal data into TypeId1
	err = newStrictDecoder(data).Decode(&dst.TypeId1)
	if err == nil {
		jsonTypeId1, _ := json.Marshal(dst.TypeId1)
		if string(jsonTypeId1) == "{}" { // empty struct
			dst.TypeId1 = nil
		} else {
			if err = validator.Validate(dst.TypeId1); err != nil {
				dst.TypeId1 = nil
			} else {
				match++
			}
...
func (src CorporationsProjectsDetailConfigurationdeliveritemItemsInner) MarshalJSON() ([]byte, error) {
	...
	if src.TypeId1 != nil {
		return json.Marshal(&src.TypeId1)
	}
